    ...
    <div className="about stack gap-lg">
      <header className="about__header">
        ...
        <p className="about__lead">
          A medically sourced overview of what celiac disease is, how it’s diagnosed, and how it’s treated by Sian.
        </p>
      </header>
      ...
      <section className="card">
        ...
        <p>
          ...
          small intestine when gluten is consumed regularly.
        </p>
      </section>
