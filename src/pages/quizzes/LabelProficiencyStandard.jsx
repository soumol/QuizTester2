// src/pages/quizzes/LabelProficiencyStandard.jsx
...
export default function LabelProficiencyStandard() {
  ...
  React.useEffect(() => {
    const selected = shuffle(LABEL_STANDARD_QUESTIONS).slice(0, 10);
    ...
    return (
      <div className="container">
        <div className="card results">
          <h1>Label Proficiency — Standard Results</h1>
  ...
  return (
    <div className="container">
      <div className="card">
        ...
        <h1>Gluten-Free Label Proficiency — Standard</h1>
